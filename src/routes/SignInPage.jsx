...
const SignInPage = () => {
	...
	return (
		...
		<form className="form gap-2" onSubmit={handleSignInSubmit}>
			...
			<input required type="text" id="username" className="input" value={signInData.username} onChange={handleSignInData}/>
			
			<label htmlFor="password" className="label">*비밀번호:</label>
			<input required type="password" id="password" className="input" value={signInData.password} onChange={handleSignInData}/>
