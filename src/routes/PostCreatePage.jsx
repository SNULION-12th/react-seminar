...
const PostCreatePage = () => {
  ...
  useEffect(() => {
    //make a set "acc" of all tags in every post, put them in a tagList and update "tags" as this tagList
    ...
    setTags([...tagList]);
  }, []); //bc it's empty, it runs only once unless PostCreatePage() runs again
